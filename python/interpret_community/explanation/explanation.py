...
def _aggregate_streamed_local_explanations(explainer, evaluation_examples, model_task, features,
                                           batch_size, **kwargs):
    ...
    :param evaluation_examples: The evaluation examples.
    :type evaluation_examples: DatasetWrapper
    :param model_task: Indicates if this is a classification or regression explanation.
        Unknown by default.
    ...
    classification = model_task is ModelTask.Classification
    for i in range(0, dataset_len, batch_size):
        ...
        if importance_values is None:
            if model_task is ModelTask.Unknown and ClassesMixin._does_quack(local_explanation_row):
...
def save_explanation(explanation, path, exist_ok=False):
    ...
    Defined here for backwards compatibility.  The method has been moved to serialization.py.
    Note this method is monkey patched there to avoid circular dependencies.
